...
import { CONST_TRANG_THAI_HOAT_DONG, CONST_TINH_TRANG_GIAY_CHUNG_NHAN } from "./../../../../constants/constants";
...
const CoSoSanXuatKinhDoanh = () => {
    ...
    // useEffect(() => {
    //     if (qs.action) {
    //         if (qs.action === actID.ACT_ID_CO_SO_SAN_XUAT_KINH_DOANH.ACT_CREATE) {
    //             const hoSoMotCuaId = qs.hoSoMotCuaId;
    //             onCreate(hoSoMotCuaId);
    //         }
    //         if (qs.action === actID.ACT_ID_CO_SO_SAN_XUAT_KINH_DOANH.ACT_UPDATE && qs.id) {
    //             const id = qs.id;
    //             const hoSoMotCuaId = qs.hoSoMotCuaId;
    ...
    //             onSearch();
    //         }
    //         if (qs.action === actID.ACT_ID_CO_SO_SAN_XUAT_KINH_DOANH.ACT_REPORT) {
    //             onReport();
    //         }
    //         if (qs.action === actID.ACT_ID_CO_SO_SAN_XUAT_KINH_DOANH.ACT_LIST) {
    //             onList();
    //         }
    //         if (qs.action === actID.ACT_ID_CO_SO_SAN_XUAT_KINH_DOANH.ACT_TCB_CREATE) {
    //             const hoSoMotCuaId = qs.hoSoMotCuaId;
    //             const id = qs.id;
    //             onTCBCreate(hoSoMotCuaId, id);
    //         }
    ...
    useEffect(() => {
        if (qs.loaded && Array.isArray(quanHuyenQuanLys)) {
            ...
            const soGiayPhepDkkd = qs.sgp_dkkd;
            const soChungNhanAttp = qs.scn_attp;
            const tenCoSo = qs.ten_co_so;
            ...
            const diaDiemKinhDoanh = qs.dia_diem_kinh_doanh;
