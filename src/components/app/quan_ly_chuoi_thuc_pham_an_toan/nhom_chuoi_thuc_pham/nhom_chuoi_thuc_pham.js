...
import NhomChuoiThucPhamList from "./nhom_chuoi_thuc_pham_list";
import NhomChuoiThucPhamForm from "./nhom_chuoi_thuc_pham_form";
...
const NhomChuoiThucPham = (props) => {
    ...
    const renderActionCreate = () => {
        let result = {};
        result.key = actID.ACT_ID_NHOM_CHUOI_THUC_PHAM.ACT_CREATE;
    ...
    const renderActionDelete = () => {
        ...
        result.key = actID.ACT_ID_NHOM_CHUOI_THUC_PHAM.ACT_DELETE;
    ...
    const renderActionSearch = () => {
        let result = {};
        result.key = actID.ACT_ID_NHOM_CHUOI_THUC_PHAM.ACT_SEARCH;
        result.disabled = false;
        result.hidden = (isVisiableList && !isVisiableSearch) ? false : true;
    ...
    return (
        <React.Fragment>
            {isVisiableForm && <NhomChuoiThucPhamForm {...props} />}
            {isVisiableList && <NhomChuoiThucPhamList {...props} />}
        </React.Fragment>
    );
}
