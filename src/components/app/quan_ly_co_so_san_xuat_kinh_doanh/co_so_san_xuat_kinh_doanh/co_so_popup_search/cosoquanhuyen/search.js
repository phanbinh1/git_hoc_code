        ...
        {show && <React.Fragment>
                        ...
                        <div className="col-md-6">
                            <Form.Item label="Số điện thoại">
                                <Input
                                    ...
                                    onChange={(e) => {
                                        onChange({ ...searchData, soDienThoai: e.target.value })
                                    }}
                        ...
                        <div className="col-md-6">
                            <Form.Item label="Số chứng nhận ATTP">
                                <Input
                                    ...
                                    onChange={(e) => {
                                        onChange({ ...searchData, soChungNhanVsAttp: e.target.value })
                                    }}
                                ...
                                >
                                    {
                                        dsQuanHuyen.map((item, i) => {
                                            return <Select.Option key={i} value={item.ma} disabled={quanHuyenDaCoDuLieu.findIndex(qh => qh.ma === item.ma) === -1}>{item.ten}</Select.Option>;
                                        })
                                    }
                                </Select>
                            </Form.Item>
            ...
            <div className="form-group" style={{ textAlign: "right" }}>
                <Popover content="Quận Huyện bắt buộc chọn">
                    <Button type="primary" onClick={onSubmit} disabled={!searchData.maQuanHuyen}>
