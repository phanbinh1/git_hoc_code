...
const List = ({
    ...
    const getDsCoSo = (object) => dispatch(actCoSoSanXuatKinhDoanh.getAllRequest({
        ...object,
        pageKey: `${pageKeys.PAGE_KEY_CO_SO_SAN_XUAT_KINH_DOANH}_POPUP_SEARCH_CAPGCN`,

    }))
    const [dataSource, setDataSource] = useState([]);

    useEffect(() => {
        const index = paginations.findIndex(item => item.key === `${pageKeys.PAGE_KEY_CO_SO_SAN_XUAT_KINH_DOANH}_POPUP_SEARCH_CAPGCN`);;
    ...
    return <React.Fragment>
        ...
        <CommonPagination
            ...
            paginationKey={`${pageKeys.PAGE_KEY_CO_SO_SAN_XUAT_KINH_DOANH}_POPUP_SEARCH_CAPGCN`}
        />
    </React.Fragment>
}
