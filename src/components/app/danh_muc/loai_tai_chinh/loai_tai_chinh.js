...
import LoaiTaiChinhList from "./loai_tai_chinh_list";
import LoaiTaiChinhForm from "./loai_tai_chinh_form";
...
const LoaiTaiChinh = ({
    ...
    const renderActionCreate = () => {
        let result = {};
        result.key = actID.ACT_ID_LOAI_TAI_CHINH.ACT_CREATE;
    ...
    const renderActionDelete = () => {
        ...
        result.key = actID.ACT_ID_LOAI_TAI_CHINH.ACT_DELETE;
    ...
    const renderActionSearch = () => {
        let result = {};
        result.key = actID.ACT_ID_LOAI_TAI_CHINH.ACT_SEARCH;
        result.disabled = false;
        result.hidden = (isVisibleList && !isVisibleSearch) ? false : true;
    ...
    return <Fragment>
        {isVisibleForm && <LoaiTaiChinhForm handleBack={handleBack} />}
        {isVisibleList && <LoaiTaiChinhList
            pageKey={pageKey}
