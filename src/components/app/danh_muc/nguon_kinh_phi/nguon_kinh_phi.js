...
import NguonKinhPhiList from "./nguon_kinh_phi_list";
import NguonKinhPhiForm from "./nguon_kinh_phi_form";
...
const NguonKinhPhi = ({
    ...
    const renderActionCreate = () => {
        let result = {};
        result.key = actID.ACT_ID_NGUON_KINH_PHI.ACT_CREATE;
    ...
    const renderActionDelete = () => {
        ...
        result.key = actID.ACT_ID_NGUON_KINH_PHI.ACT_DELETE;
    ...
    const renderActionSearch = () => {
        let result = {};
        result.key = actID.ACT_ID_NGUON_KINH_PHI.ACT_SEARCH;
        result.disabled = false;
        result.hidden = (isVisibleList && !isVisibleSearch) ? false : true;
    ...
    return <Fragment>
        {isVisibleForm && <NguonKinhPhiForm handleBack={handleBack} />}
        {isVisibleList && <NguonKinhPhiList
            pageKey={pageKey}
