...
export const getOneRequest = (object = {}) => {
    ...
    return dispatch => {
        if (!data.id) {
            ...
            return api.get({
                url: apiUrl.API_QL_DM_CHI_TIEU + `/${data.id}`,
                controller
            }).then(res => {
                if (res && res.status) {
...
const handleGetAll = (values) => {
    return {
        type: type.TYPE_QLCTDSON_DM_CHI_TIEU_LIST,
        values
    }
}
...
export const handleGetOne = (value) => {
    return {
        type: type.TYPE_QLCTDSON_DM_CHI_TIEU_EDIT,
        value
    }
}
...
const handleCreate = (value) => {
    return {
        type: type.TYPE_QLCTDSON_DM_CHI_TIEU_CREATE,
        value
    }
}
...
const handleUpdate = (value) => {
    return {
        type: type.TYPE_QLCTDSON_DM_CHI_TIEU_UPDATE,
        value
    }
}
...
const handleDelete = (values) => {
    return {
        type: type.TYPE_QLCTDSON_DM_CHI_TIEU_DELETE,
        values
    }
}