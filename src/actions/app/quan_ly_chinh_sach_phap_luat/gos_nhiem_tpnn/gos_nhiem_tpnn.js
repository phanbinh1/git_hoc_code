...
export const getAllRequest = (object = {}) => {
    ...
    return dispatch => {
        return api.get({
            url: apiUrl.API_GOS_NGHIEM_TPNN,
            data,
            controller
        }).then(res => {
            if (res && res.status) {
...
export const getOneRequest = (object = {}) => {
    ...
    return dispatch => {
        if (!data.id) {
            ...
            return api.get({
                url: apiUrl.API_GOS_NGHIEM_TPNN + `/${data.id}`,
                controller
            }).then(res => {
...
const handleGetAll = (values) => {
    return {
        type: type.TYPE_GOS_NHIEM_TPNN_LIST,
        values,
    }
}
...
export const handleGetOne = (value) => {
    return {
        type: type.TYPE_GOS_NHIEM_TPNN_EDIT,
        value,
    }
}
...
const handleCreate = (value) => {
    return {
        type: type.TYPE_GOS_NHIEM_TPNN_CREATE,
        value,
    }
}
...
const handleUpdate = (value) => {
    return {
        type: type.TYPE_GOS_NHIEM_TPNN_UPDATE,
        value,
    }
}
...
const handleDelete = (values) => {
    return {
        type: type.TYPE_GOS_NHIEM_TPNN_DELETE,
        values,
    }
}