...
export const getAllRequest = (object = {}) => {
    ...
    return dispatch => {
        return api.get({
            url: apiUrl.API_QUAN_LY_CHO_SIEU_THI,
            data,
            controller
        }).then(res => {
            if (res && res.status) {
...
export const getOneRequest = (object = {}) => {
    ...
    return dispatch => {
        if (!data.id) {
            ...
            return api.get({
                url: apiUrl.API_QUAN_LY_CHO_SIEU_THI + `/${data.id}`,
                controller
            }).then(res => {
...
const handleGetAll = (values) => {
    return {
        type: type.TYPE_QUAN_LY_CHO_SIEU_THI_LIST,
        values,
    }
}
...
export const handleGetOne = (value) => {
    return {
        type: type.TYPE_QUAN_LY_CHO_SIEU_THI_EDIT,
        value,
    }
}
...
const handleCreate = (value) => {
    return {
        type: type.TYPE_QUAN_LY_CHO_SIEU_THI_CREATE,
        value,
    }
}
...
const handleUpdate = (value) => {
    return {
        type: type.TYPE_QUAN_LY_CHO_SIEU_THI_UPDATE,
        value,
    }
}
...
const handleDelete = (values) => {
    return {
        type: type.TYPE_QUAN_LY_CHO_SIEU_THI_DELETE,
        values,
    }
}