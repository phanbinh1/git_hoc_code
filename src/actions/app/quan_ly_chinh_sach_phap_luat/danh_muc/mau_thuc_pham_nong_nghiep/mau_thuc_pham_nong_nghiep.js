...
export const getAllRequest = (object = {}) => {
    ...
    return dispatch => {
        return api.get({
            url: apiUrl.API_MAU_THUC_PHAM_NN,
            data,
            controller
        }).then(res => {
            if (res && res.status) {
...
export const getOneRequest = (object = {}) => {
    ...
    return dispatch => {
        if (!data.id) {
            ...
            return api.get({
                url: apiUrl.API_MAU_THUC_PHAM_NN + `/${data.id}`,
                controller
            }).then(res => {
...
const handleGetAll = (values) => {
    return {
        type: type.TYPE_MAU_THUC_PHAM_NN_LIST,
        values,
    }
}
...
export const handleGetOne = (value) => {
    return {
        type: type.TYPE_MAU_THUC_PHAM_NN_EDIT,
        value,
    }
}
...
const handleCreate = (value) => {
    return {
        type: type.TYPE_MAU_THUC_PHAM_NN_CREATE,
        value,
    }
}
...
const handleUpdate = (value) => {
    return {
        type: type.TYPE_MAU_THUC_PHAM_NN_UPDATE,
        value,
    }
}
...
const handleDelete = (values) => {
    return {
        type: type.TYPE_MAU_THUC_PHAM_NN_DELETE,
        values,
    }
}