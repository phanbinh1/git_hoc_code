...
export const getOneRequest = (object = {}) => {
    ...
    return dispatch => {
        if (!data.id) {
            ...
            return api.get({
                url: apiUrl.API_TRUYEN_THONG + `/${data.id}`,
                controller
            }).then(res => {
...
const handleGetAll = (values) => {
    return {
        type: type.TYPE_TRUYEN_THONG_LIST,
        values,
    }
}
...
export const handleGetOne = (value) => {
    return {
        type: type.TYPE_TRUYEN_THONG_EDIT,
        value,
    }
}
...
const handleCreate = (value) => {
    return {
        type: type.TYPE_TRUYEN_THONG_CREATE,
        value,
    }
}
...
const handleUpdate = (value) => {
    return {
        type: type.TYPE_TRUYEN_THONG_UPDATE,
        value,
    }
}
...
const handleDelete = (values) => {
    return {
        type: type.TYPE_TRUYEN_THONG_DELETE,
        values,
    }
}