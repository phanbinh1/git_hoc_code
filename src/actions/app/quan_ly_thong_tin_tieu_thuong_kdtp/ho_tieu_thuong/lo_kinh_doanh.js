...
export const getAllRequest = (object = {}) => {
    ...
    return dispatch => {
        return api.get({
            url: `${apiUrl.API_LO_KINH_DOANH}/getbyidhotieuthuong`,
            data,
            controller
        }).then(res => {
            if (res && res.status) {
...
export const getOneRequest = (object = {}) => {
    ...
    return dispatch => {
        if (!data.id) {
            ...
            return api.get({
                url: `${apiUrl.API_LO_KINH_DOANH}/getbyid/${data.id}`,
                controller
            }).then(res => {
...
export const createRequest = (object = {}) => {
    ...
    return dispatch => {
        return api.post({
            url: `${apiUrl.API_LO_KINH_DOANH}/create?idHoTieuThuong=${data.idHoTieuThuong}`,
            data,
            controller
        }).then(res => {
            if (res && res.status) {
...
export const updateRequest = (object = {}) => {
    ...
    return dispatch => {
        return api.put({
            url: `${apiUrl.API_LO_KINH_DOANH}/update?idHoTieuThuong=${data.idHoTieuThuong}`,
            data,
            controller
        }).then(res => {
            if (res && res.status) {
...
export const deleteRequest = (object = {}) => {
    ...
    return dispatch => {
        return api.del({
            url: `${apiUrl.API_LO_KINH_DOANH}/del`,
            data,
            controller
        }).then(res => {
            if (res && res.status) {
...
const handleGetAll = (values) => {
    return {
        type: type.TYPE_LO_KINH_DOANH_LIST,
        values,
    }
}
...
export const handleGetOne = (value) => {
    return {
        type: type.TYPE_LO_KINH_DOANH_EDIT,
        value,
    }
}
...
const handleCreate = (value) => {
    return {
        type: type.TYPE_LO_KINH_DOANH_CREATE,
        value,
    }
}
...
const handleUpdate = (value) => {
    return {
        type: type.TYPE_LO_KINH_DOANH_UPDATE,
        value,
    }
}
...
const handleDelete = (values) => {
    return {
        type: type.TYPE_LO_KINH_DOANH_DELETE,
        values,
    }
}