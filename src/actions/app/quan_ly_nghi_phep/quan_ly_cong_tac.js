...
export const getAllRequest = (object = {}) => {
    ...
    return dispatch => {
        return api.get({
            url: apiUrl.API_QUAN_LY_CONG_TAC,
            data,
            controller
        }).then(res => {
            if (res && res.status) {
...
export const getOneRequest = (object = {}) => {
    ...
    return dispatch => {
        if (!data.id) {
            ...
            return api.get({
                url: apiUrl.API_QUAN_LY_CONG_TAC + `/${data.id}`,
                controller
            }).then(res => {
                if (res && res.status) {
...
const handleGetAll = (values) => {
    return {
        type: type.TYPE_QUAN_LY_CONG_TAC_LIST,
        values
    }
}
...
export const handleGetOne = (value) => {
    return {
        type: type.TYPE_QUAN_LY_CONG_TAC_EDIT,
        value
    }
}
...
const handleCreate = (value) => {
    return {
        type: type.TYPE_QUAN_LY_CONG_TAC_CREATE,
        value
    }
}
...
const handleUpdate = (value) => {
    return {
        type: type.TYPE_QUAN_LY_CONG_TAC_UPDATE,
        value
    }
}
...
const handleDelete = (values) => {
    return {
        type: type.TYPE_QUAN_LY_CONG_TAC_DELETE,
        values
    }
}