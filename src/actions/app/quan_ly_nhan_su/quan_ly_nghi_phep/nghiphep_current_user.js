...
export const getAllRequest = (object = {}) => {
    ...
    return dispatch => {
        return api.get({
            url: apiUrl.API_THONGTIN_NGHIPHEP + "/user/current",
            data,
            controller
        }).then(res => {
            if (res && res.status) {
...
const handleGetAll = (values) => {
    return {
        type: type.TYPE_THONGTIN_NGHIPHEP_USER_LIST,
        values
    }
}
...
export const handleGetOne = (value) => {
    return {
        type: type.TYPE_THONGTIN_NGHIPHEP_USER_EDIT,
        value
    }
}
...
const handleCreate = (value) => {
    return {
        type: type.TYPE_THONGTIN_NGHIPHEP_USER_CREATE,
        value
    }
}
...
const handleUpdate = (value) => {
    return {
        type: type.TYPE_THONGTIN_NGHIPHEP_USER_UPDATE,
        value
    }
}
...
const handleDelete = (values) => {
    return {
        type: type.TYPE_THONGTIN_NGHIPHEP_USER_DELETE,
        values
    }
}