...
export const getAllRequest = (object = {}) => {
    ...
    return dispatch => {
        return api.get({
            url: apiUrl.API_DANHHIEU_THIDUA,
            data,
            controller
        }).then(res => {
            if (res && res.status) {
...
export const getOneRequest = (object = {}) => {
    ...
    return dispatch => {
        if (!data.id) {
            ...
            return api.get({
                url: apiUrl.API_DANHHIEU_THIDUA + `/${data.id}`,
                controller
            }).then(res => {
                if (res && res.status) {
...
const handleGetAll = (values) => {
    return {
        type: type.TYPE_DANHHIEU_THIDUA_LIST,
        values
    }
}
...
export const handleGetOne = (value) => {
    return {
        type: type.TYPE_DANHHIEU_THIDUA_EDIT,
        value
    }
}
...
const handleCreate = (value) => {
    return {
        type: type.TYPE_DANHHIEU_THIDUA_CREATE,
        value
    }
}
...
const handleUpdate = (value) => {
    return {
        type: type.TYPE_DANHHIEU_THIDUA_UPDATE,
        value
    }
}
...
const handleDelete = (values) => {
    return {
        type: type.TYPE_DANHHIEU_THIDUA_DELETE,
        values
    }
}