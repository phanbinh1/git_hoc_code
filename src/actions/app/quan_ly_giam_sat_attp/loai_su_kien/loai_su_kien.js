...
export const getOneRequest = (object = {}) => {
    ...
    return dispatch => {
        if (!data.id) {
            ...
            return api.get({
                url: apiUrl.API_LOAI_SU_KIEN + `/${data.id}`,
                controller
            }).then(res => {
...
const handleGetAll = (values) => {
    return {
        type: type.TYPE_LOAI_SU_KIEN_LIST,
        values,
    }
}
...
export const handleGetOne = (value) => {
    return {
        type: type.TYPE_LOAI_SU_KIEN_EDIT,
        value,
    }
}
...
const handleCreate = (value) => {
    return {
        type: type.TYPE_LOAI_SU_KIEN_CREATE,
        value,
    }
}
...
const handleUpdate = (value) => {
    return {
        type: type.TYPE_LOAI_SU_KIEN_UPDATE,
        value,
    }
}
...
const handleDelete = (values) => {
    return {
        type: type.TYPE_LOAI_SU_KIEN_DELETE,
        values,
    }
}