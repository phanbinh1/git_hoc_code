...
export const getOneRequest = (object = {}) => {
    ...
    return dispatch => {
        if (!data.id) {
            ...
            return api.get({
                url: apiUrl.API_TCB_NHOM_PHAN_NHOM + `/${data.id}`,
                controller
            }).then(res => {
                if (res && res.status) {
...
const handleGetAll = (values) => {
    return {
        type: type.TYPE_NHOM_PHAN_NHOM_LIST,
        values
    }
}
...
export const handleGetOne = (value) => {
    return {
        type: type.TYPE_NHOM_PHAN_NHOM_EDIT,
        value
    }
}
...
const handleCreate = (value) => {
    return {
        type: type.TYPE_NHOM_PHAN_NHOM_CREATE,
        value
    }
}
...
const handleUpdate = (value) => {
    return {
        type: type.TYPE_NHOM_PHAN_NHOM_UPDATE,
        value
    }
}
...
const handleDelete = (values) => {
    return {
        type: type.TYPE_NHOM_PHAN_NHOM_DELETE,
        values
    }
}