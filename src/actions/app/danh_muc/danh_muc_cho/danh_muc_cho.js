...
export const getAllRequest = (object = {}) => {
  ...
  return (dispatch) => {
    return api
      .get({
        url: `${apiUrl.API_DANH_MUC_CHO}/getall`,
        data,
        controller,
      })
      .then((res) => {
...
export const getOneRequest = (object = {}) => {
  ...
  return (dispatch) => {
    if (!data.id) {
      ...
      return api
        .get({
          url: `${apiUrl.API_DANH_MUC_CHO}/getbyid/${data.id}`,
          controller,
        })
        .then((res) => {
...
export const createRequest = (object = {}) => {
  ...
  return (dispatch) => {
    return api
      .post({
        url: `${apiUrl.API_DANH_MUC_CHO}/create`,
        data,
        controller,
      })
      .then((res) => {
...
export const updateRequest = (object = {}) => {
  ...
  return (dispatch) => {
    return api
      .put({
        url: `${apiUrl.API_DANH_MUC_CHO}/update`,
        data,
        controller,
      })
      .then((res) => {
...
export const deleteRequest = (object = {}) => {
  ...
  return (dispatch) => {
    return api
      .del({
        url: `${apiUrl.API_DANH_MUC_CHO}/del`,
        data,
        controller,
      })
      .then((res) => {
...
const handleGetAll = (values) => {
  return {
    type: type.TYPE_DANH_MUC_CHO_LIST,
    values,
  };
};
...
export const handleGetOne = (value) => {
  return {
    type: type.TYPE_DANH_MUC_CHO_EDIT,
    value,
  };
};
...
const handleCreate = (value) => {
  return {
    type: type.TYPE_DANH_MUC_CHO_CREATE,
    value,
  };
};
...
const handleUpdate = (value) => {
  return {
    type: type.TYPE_DANH_MUC_CHO_UPDATE,
    value,
  };
};
...
const handleDelete = (values) => {
  return {
    type: type.TYPE_DANH_MUC_CHO_DELETE,
    values,
  };
};
