...
export const getOneRequest = (object = {}) => {
    ...
    return dispatch => {
        if (!data.id) {
            ...
            return api.get({
                url: apiUrl.API_DOAN_THAM_DINH + `/${data.id}`,
                controller
            }).then(res => {
                if (res && res.status) {
...
const handleGetAll = (values) => {
    return {
        type: type.TYPE_DOAN_THAM_DINH_LIST,
        values
    }
}
...
export const handleGetOne = (value) => {
    return {
        type: type.TYPE_DOAN_THAM_DINH_EDIT,
        value
    }
}
...
const handleCreate = (value) => {
    return {
        type: type.TYPE_DOAN_THAM_DINH_CREATE,
        value
    }
}
...
const handleUpdate = (value) => {
    return {
        type: type.TYPE_DOAN_THAM_DINH_UPDATE,
        value
    }
}
...
const handleDelete = (values) => {
    return {
        type: type.TYPE_DOAN_THAM_DINH_DELETE,
        values
    }
}