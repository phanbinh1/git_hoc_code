...
export const capSoRequest = (object) => {
    ...
    return dispatch => {
        return api.get({
            url: apiUrl.API_XAC_NHAN_QUANG_CAO_CAP_SO,
            data,
            controller
        }).then(res => {
            if (res && res.status) {
...
export const getAllRequest = (object = {}) => {
    ...
    return dispatch => {
        return api.get({
            url: apiUrl.API_XAC_NHAN_QUANG_CAO,
            data,
            controller
        }).then(res => {
            if (res && res.status) {
...
export const getOneRequest = (object = {}) => {
    ...
    return dispatch => {
        if (!data.id) {
            ...
            return api.get({
                url: apiUrl.API_XAC_NHAN_QUANG_CAO + `/${data.id}`,
                controller
            }).then(res => {
                if (res && res.status) {
...
const handleGetAll = (values) => {
    return {
        type: type.TYPE_XAC_NHAN_QUANG_CAO_LIST,
        values
    }
}
...
export const handleGetOne = (value) => {
    return {
        type: type.TYPE_XAC_NHAN_QUANG_CAO_EDIT,
        value
    }
}
...
const handleCreate = (value) => {
    return {
        type: type.TYPE_XAC_NHAN_QUANG_CAO_CREATE,
        value
    }
}
...
const handleUpdate = (value) => {
    return {
        type: type.TYPE_XAC_NHAN_QUANG_CAO_UPDATE,
        value
    }
}
...
const handleDelete = (values) => {
    return {
        type: type.TYPE_XAC_NHAN_QUANG_CAO_DELETE,
        values
    }
}