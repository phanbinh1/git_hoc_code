...
export const getAllRequest = (object = {}) => {
    ...
    return dispatch => {
        return api.get({
            url: apiUrl.API_HO_SO_NGO_DOC_THUC_PHAM,
            data,
            controller
        }).then(res => {
            if (res && res.status) {
...
export const getOneRequest = (object = {}) => {
    ...
    return dispatch => {
        if (!data.id) {
            ...
            return api.get({
                url: apiUrl.API_HO_SO_NGO_DOC_THUC_PHAM + `/${data.id}`,
                controller
            }).then(res => {
                if (res && res.status) {
...
export const getDieuTraRequest = (object = {}) => {
    var { data, requestSuccess, requestError, controller } = main.checkValidObjectRequest(object);
    return dispatch => {
        if (!data.id) {
            message.error({ content: "Dữ liệu đầu vào không chính xác!" });
            ...
            return api.get({
                ...
                if (res && res.status) {
                    let dieuTraNgoDocThucPham = res.result.dieuTraNgoDocThucPham,
                        hoSoNgoDocThucPham = res.result.hoSoNgoDocThucPham;
                    const result = {
                        ...dieuTraNgoDocThucPham,
                        hoSoNgoDocThucPham
                    }
                    dispatch(handleGetDieuTra(result));
...
const handleGetAll = (values) => {
    return {
        type: type.TYPE_HO_SO_NGO_DOC_THUC_PHAM_LIST,
        values
    }
}
...
export const handleGetOne = (value) => {
    return {
        type: type.TYPE_HO_SO_NGO_DOC_THUC_PHAM_EDIT,
        value
    }
}

export const handleGetDieuTra = (value) => {
    return {
...
const handleCreate = (value) => {
    return {
        type: type.TYPE_HO_SO_NGO_DOC_THUC_PHAM_CREATE,
        value
    }
}
...
const handleUpdate = (value) => {
    return {
        type: type.TYPE_HO_SO_NGO_DOC_THUC_PHAM_UPDATE,
        value
    }
}
...
const handleDelete = (values) => {
    return {
        type: type.TYPE_HO_SO_NGO_DOC_THUC_PHAM_DELETE,
        values
    }
}
...
export const deleteFile_Request = (object) => {
    ...
    return dispatch => {
        return api.del({
            url: apiUrl.API_QTDT_XL_NDTP_UPLOAD_FILE,
            data,
        }).then(function (res) {
            if (res && res.status) {
                requestSuccess();
