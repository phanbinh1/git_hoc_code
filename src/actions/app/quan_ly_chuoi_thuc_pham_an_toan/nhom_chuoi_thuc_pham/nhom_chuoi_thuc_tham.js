...
export const getOneRequest = (object = {}) => {
    ...
    return dispatch => {
        if (!data.ma) {
            ...
            return api.get({
                url: apiUrl.API_NHOM_CHUOI_THUC_PHAM + `/ma/${data.ma}`,
                controller
            }).then(res => {
                if (res && res.status) {
...
const handleGetAll = (values) => {
    return {
        type: type.TYPE_NHOM_CHUOI_THUC_PHAM_LIST,
        values
    }
}
...
export const handleGetOne = (value) => {
    return {
        type: type.TYPE_NHOM_CHUOI_THUC_PHAM_EDIT,
        value
    }
}
...
const handleCreate = (value) => {
    return {
        type: type.TYPE_NHOM_CHUOI_THUC_PHAM_CREATE,
        value
    }
}
...
const handleUpdate = (value) => {
    return {
        type: type.TYPE_NHOM_CHUOI_THUC_PHAM_UPDATE,
        value
    }
}
...
const handleDelete = (values) => {
    return {
        type: type.TYPE_NHOM_CHUOI_THUC_PHAM_DELETE,
        values
    }
}