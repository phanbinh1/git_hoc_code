...
export const getAllRequest = (object = {}) => {
    ...
    return dispatch => {
        return api.get({
            url: apiUrl.API_QUAN_LY_TAI_SAN_THANH_LY,
            data,
            controller
        }).then(res => {
            if (res && res.status) {
...
export const getOneRequest = (object = {}) => {
    ...
    return dispatch => {
        if (!data.id) {
            ...
            return api.get({
                url: apiUrl.API_QUAN_LY_TAI_SAN_THANH_LY + `/${data.id}`,
                controller
            }).then(res => {
...
const handleGetAll = (values) => {
    return {
        type: type.TYPE_QUAN_LY_TAI_SAN_THANH_LY_LIST,
        values,
    }
}
...
export const handleGetOne = (value) => {
    return {
        type: type.TYPE_QUAN_LY_TAI_SAN_THANH_LY_EDIT,
        value,
    }
}
...
const handleCreate = (value) => {
    return {
        type: type.TYPE_QUAN_LY_TAI_SAN_THANH_LY_CREATE,
        value,
    }
}
...
const handleUpdate = (value) => {
    return {
        type: type.TYPE_QUAN_LY_TAI_SAN_THANH_LY_UPDATE,
        value,
    }
}
...
const handleDelete = (values) => {
    return {
        type: type.TYPE_QUAN_LY_TAI_SAN_THANH_LY_DELETE,
        values,
    }
}
