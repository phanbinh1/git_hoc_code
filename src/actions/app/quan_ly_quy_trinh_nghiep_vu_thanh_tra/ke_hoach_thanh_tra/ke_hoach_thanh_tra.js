...
export const getOneRequest = (object = {}) => {
    ...
    return dispatch => {
        if (!data.hasOwnProperty("id")) {
            ...
            return api.get({
                url: apiUrl.API_QTNVTT_KE_HOACH_THANH_TRA + `/${data.id}`,
                controller
            }).then(res => {
                if (res && res.status) {
                    dispatch(handleGetOne(res.result));
                    dispatch({
                        type: type.TYPE_QTNVTT_CUOC_THANH_TRA_UPDATE_KEHOACH_BY_ID,
                        keHoachThanhKiemTra: res.result
                    })
                    requestSuccess(res);
                }
                else {
...
export const pheDuyetRequest = (object = {}) => {
    ...
    if (!data.trangThaiDuyet) {
        ...
        return dispatch => {
            return api.put({
                url: apiUrl.API_QTNVTT_KE_HOACH_THANH_TRA_PHE_DUYET(data.trangThaiDuyet),
                data,
                controller
            }).then(res => {
                if (res && res.status) {
...
const handleGetAll = (values) => {
    return {
        type: type.TYPE_QTNVTT_KE_HOACH_THANH_TRA_LIST,
        values
    }
}
...
export const handleGetOne = (value) => {
    return {
        type: type.TYPE_QTNVTT_KE_HOACH_THANH_TRA_EDIT,
        value
    }
}
...
const handleCreate = (value) => {
    return {
        type: type.TYPE_QTNVTT_KE_HOACH_THANH_TRA_CREATE,
        value
    }
}
...
const handleUpdate = (value) => {
    return {
        type: type.TYPE_QTNVTT_KE_HOACH_THANH_TRA_UPDATE,
        value
    }
}
...
const handleDelete = (values) => {
    return {
        type: type.TYPE_QTNVTT_KE_HOACH_THANH_TRA_DELETE,
        values
    }
}