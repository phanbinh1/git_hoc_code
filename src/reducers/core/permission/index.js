...
import permission_menu from "./permission_menu";
...
export const formatItem = (item) => ({
    ...item,
    type: item.type === CONST_PERMISSION_TYPE_ACTION_HIDDEN ? CONST_PERMISSION_TYPE_ACTION : (item.type === CONST_PERMISSION_TYPE_URL_HIDDEN ? CONST_PERMISSION_TYPE_URL : item.type),
    hiddenAction: item.type === CONST_PERMISSION_TYPE_ACTION_HIDDEN,
    menuLeft: item.type === CONST_PERMISSION_TYPE_URL
});
